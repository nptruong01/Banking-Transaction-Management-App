 ...
 * @author MSI-VN
 */
public class MoKhoaTK extends javax.swing.JPanel {
...
//        loadTable1();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         if (txtma.getText().equals("ID")) {
            ...
            int xn = JOptionPane.showConfirmDialog(this,"Bạn có chắc muốn mở khóa tài khoản này?","Xác nhận",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (txtsearch.getText().equals("")) {
            ...
            KhoaTKDAO spdao = new KhoaTKDAO();
            dssp=spdao.timtheotenKhoa(txtsearch.getText());
            DefaultTableModel dftbl = (DefaultTableModel)tblTK.getModel();
            dftbl.setRowCount(0);

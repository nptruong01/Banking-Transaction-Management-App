...
//        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icon/14.png")), "Gallery"));
        ...
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icon/11.png")), "Khách hàng", "Tạo tài khoản", "Quản lý thông tin KH", "Xem số dư", "Khóa tài khoản"));
//        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icon/5.png")), "Admin", "Quản lý User", "Quản lý chi nhánh"));
